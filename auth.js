...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (!form || !signinTab || !signupTab || !nameField || !title || !description || !submitLabel || !formNote) return;

  if (destinationName && accountType && accountTypeField) {
  ...
  function setMode(nextMode) {
    ...
    if (accountTypeField) accountTypeField.hidden = !signingUp || Boolean(destinationName);
